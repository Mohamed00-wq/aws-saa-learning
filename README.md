...
- [x] **01 · Foundation** — IAM, EC2, AMIs, EBS, EC2 Pricing Models, Auto Scaling, ELB
...
- [ ] **08 · Security** — KMS, ACM, Cognito, Secrets Manager, Firewall Manager, Shield, WAF, CloudHSM, GuardDuty, Detective,  
    Inspector, Macie, Security Hub, Audit Manager, Directory Service
